 ...
 * 
 */
@WebServiceClient(name = "ConfigurationServiceService", targetNamespace = "http://ws.coverity.com/v9", wsdlLocation = "http://frossi-wrkst:8082/ws/v9/configurationservice?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://frossi-wrkst:8082/ws/v9/configurationservice?wsdl");
